...
{   
    ...
    if(current_page != 1)
    {
	    ...
	    BUTTON_SetBitmapEx(level_point1_x_value.btnHandle,0,&bmp_struct70X28,0,0);//ͼƬ��СΪ70x28
	    ...
	    BUTTON_SetBitmapEx(level_point4_x_value.btnHandle,0,&bmp_struct70X28,0,0);//ͼƬ��СΪ70x28

		BUTTON_SetBitmapEx(level_point1_y_value.btnHandle,0,&bmp_struct70X28,0,0);//ͼƬ��СΪ70x28
	    ...
	    BUTTON_SetBitmapEx(level_point4_y_value.btnHandle,0,&bmp_struct70X28,0,0);//ͼƬ��СΪ70x28
    ...
    else
    {
	    ...
	    BUTTON_SetBitmapEx(level_point5_x_value.btnHandle,0,&bmp_struct70X28,0,0);//ͼƬ��СΪ70x28
	    BUTTON_SetBitmapEx(level_point5_y_value.btnHandle,0,&bmp_struct70X28,0,0);//ͼƬ��СΪ70x28

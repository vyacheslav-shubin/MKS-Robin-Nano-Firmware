...
*                                       http://www.ucgui.com
*
*                             (c) Copyright 2005-2006, UCGUIרҵ��̳, ѧϰ����UCGUI
*
...
*/
//����:Terminal  15�Ŵ���
/*0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ��󱸱곧����׵������ȷ��������ػֻؼ��Ӽ��������Ŀ��ȴ����������ͷ��δ��������ӡ����Ԥ������������������׼������һҳ���ȿ����ٵ�˫��ͨ������Ĭ��������ֹͣ��������ȷ�����ʱ���ϵͳ����У�����屾������������ѡ��������ӱո����������ĵ����ȫ��ռ��ȡ���Ҳ���������������������˿ڸ���״̬��+-_>''!~:;\/%., ?*/
#ifndef _FONT_LIB_H_
#define _FONT_LIB_H_

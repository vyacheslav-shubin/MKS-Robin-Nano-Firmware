...
{   
    ...
    if(current_page != 1)
    {
	    ...
	    BUTTON_SetBitmapEx(Xstroke.btnHandle,0,&bmp_struct70X28,0,0);//ͼƬ��СΪ70x28
	    BUTTON_SetBitmapEx(Ystroke.btnHandle,0,&bmp_struct70X28,0,0);
	    BUTTON_SetBitmapEx(Zstroke.btnHandle,0,&bmp_struct70X28,0,0);
	    BUTTON_SetBitmapEx(X_min_pos.btnHandle,0,&bmp_struct70X28,0,0);//ͼƬ��СΪ70x28
		
	    BUTTON_SetBitmapEx(Xstroke_default.btnHandle,0,&bmp_struct70X28,0,0);//ͼƬ��СΪ70x28
	    ...
	    BUTTON_SetBitmapEx(X_min_pos_default.btnHandle,0,&bmp_struct70X28,0,0);//ͼƬ��СΪ70x28
    ...
    else
    {
	    ...
	    BUTTON_SetBitmapEx(Y_min_pos.btnHandle,0,&bmp_struct70X28,0,0);//ͼƬ��СΪ70x28
	    BUTTON_SetBitmapEx(Z_min_pos.btnHandle,0,&bmp_struct70X28,0,0);
		
	    BUTTON_SetBitmapEx(Y_min_pos_default.btnHandle,0,&bmp_struct70X28,0,0);//ͼƬ��СΪ70x28

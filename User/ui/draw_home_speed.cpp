...
{   
    ...
    BUTTON_SetBitmapEx(XYHomeSpeed.btnHandle,0,&bmp_struct70X28,0,0);//ͼƬ��СΪ70x28
    ...
    //BUTTON_SetBitmapEx(XHomeSpeed_default.btnHandle,0,&bmp_struct90X30,0,5);//ͼƬ��СΪ70x28

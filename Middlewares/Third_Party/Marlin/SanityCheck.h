 ...
 */
#if 0//ENABLED(PIDTEMPBED) && ENABLED(BED_LIMIT_SWITCHING)
...
#if 0//!defined(USE_XMIN_PLUG) && !defined(USE_XMAX_PLUG) && !(ENABLED(Z_DUAL_ENDSTOPS) && WITHIN(Z2_USE_ENDSTOP, _XMAX_, _XMIN_))
  #error "You must enable USE_XMIN_PLUG or USE_XMAX_PLUG."
#endif
//#if _AXIS_PLUG_UNUSED_TEST(Y)
#if 0//!defined(USE_YMIN_PLUG) && !defined(USE_YMAX_PLUG) && !(ENABLED(Z_DUAL_ENDSTOPS) && WITHIN(Z2_USE_ENDSTOP, _YMAX_, _YMIN_))
  #error "You must enable USE_YMIN_PLUG or USE_YMAX_PLUG."
#endif
//#if _AXIS_PLUG_UNUSED_TEST(Z)
#if 0//!defined(USE_ZMIN_PLUG) && !defined(USE_ZMAX_PLUG) && !(ENABLED(Z_DUAL_ENDSTOPS) && WITHIN(Z2_USE_ENDSTOP, _ZMAX_, _ZMIN_))

...
{   
    ...
    if(current_page != 1)
    {
        ...
        BUTTON_SetBmpFileName(XSteps_value.btnHandle, "bmp_value_blank.bin",1);        
        BUTTON_SetBmpFileName(YSteps_value.btnHandle, "bmp_value_blank.bin",1);
        BUTTON_SetBmpFileName(ZSteps_value.btnHandle, "bmp_value_blank.bin",1);
        BUTTON_SetBmpFileName(E0Steps_value.btnHandle, "bmp_value_blank.bin",1);
    ...
    else
    {
        ...
        BUTTON_SetBmpFileName(E1Steps_value.btnHandle, "bmp_value_blank.bin",1);

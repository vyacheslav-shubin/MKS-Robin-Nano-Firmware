    ...
    switch (pMsg->MsgId)
    {
    	...
    	case WM_NOTIFY_PARENT:
    		if(pMsg->Data.v == WM_NOTIFICATION_RELEASED)
    		{
    			...
    			{
    			//��ȡ�����ļ��е�mksCfg.bed_leveling_methodֵΪ0,3,5
    			//Ȼ������3��ֵ�е�1��д��eeprom
    			//Ȼ��mksCfg.bed_leveling_method=1<<mksCfg.bed_leveling_method;
    			//��ʹ���Զ���ƽ,mksCfg.bed_leveling_method=NULL_BED_LEVELING;
			...
			//д��eeprom������mksCfg.bed_leveling_methodλ
			////(1<<3)=8 ;(1<<5)=32

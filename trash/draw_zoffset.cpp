...
void draw_Zoffset()
{
	...
	buttonStep01.btnHandle = BUTTON_CreateEx(INTERVAL_V,  BTN_Y_PIXEL+INTERVAL_H,BTN_X_PIXEL, BTN_Y_PIXEL, hZoffsetWnd, BUTTON_CF_SHOW, 0, alloc_win_id());
	buttonStep05.btnHandle = BUTTON_CreateEx(BTN_X_PIXEL+INTERVAL_V*2,  BTN_Y_PIXEL+INTERVAL_H,BTN_X_PIXEL, BTN_Y_PIXEL, hZoffsetWnd, BUTTON_CF_SHOW, 0, alloc_win_id());
	...
	buttonRet.btnHandle = BUTTON_CreateEx(BTN_X_PIXEL*3+INTERVAL_V*4,  BTN_Y_PIXEL+INTERVAL_H,BTN_X_PIXEL, BTN_Y_PIXEL, hZoffsetWnd, BUTTON_CF_SHOW, 0, alloc_win_id());

...
//				//MessageF(" success on attempt %d\n", (connectAttemptNumber % retriesPerBaudRate) + 1);
	...
	case done:
		...
		//uploadPort.end();				//�������ô���	// disable the port, it has a high interrupt priority
		//uploadPort_close();
...
static const uint32_t FirmwareAddress = 0x00000000; //�̼�
static const uint32_t WebFilesAddress = 0x00100000; //�ļ�ϵͳ
...
void ResetWiFiForUpload(int begin_or_end)
{
	...
	GPIO_InitStructure.Pin = GPIO_Pin_8;//PC7����Ϊ���룬����ʱ����Ϊ���
	GPIO_InitStructure.Mode = GPIO_MODE_OUTPUT_PP; 
	HAL_GPIO_Init(GPIOA, &GPIO_InitStructure);
       #else
       GPIO_InitStructure.Speed = GPIO_SPEED_FREQ_LOW;
	GPIO_InitStructure.Pin = GPIO_Pin_13;//PC7����Ϊ���룬����ʱ����Ϊ���
	GPIO_InitStructure.Mode = GPIO_MODE_OUTPUT_PP; 
	...
	else
	{
		...
		GPIO_InitStructure.Speed = GPIO_SPEED_FREQ_HIGH;
		GPIO_InitStructure.Pin = GPIO_Pin_8;//PF2����Ϊ���룬����ʱ����Ϊ���
		...
		GPIO_InitStructure.Speed = GPIO_SPEED_FREQ_LOW;
		GPIO_InitStructure.Pin = GPIO_Pin_13;//PF2����Ϊ���룬����ʱ����Ϊ���
		GPIO_InitStructure.Mode = GPIO_MODE_INPUT;  
		HAL_GPIO_Init(GPIOC, &GPIO_InitStructure);       
        	#endif
	}
...
{
	esp_upload.retriesPerBaudRate = 9; //9�ֲ�����

	ResetWiFiForUpload(0); //����esp�ܽ��źţ�ʹ���������ģʽ

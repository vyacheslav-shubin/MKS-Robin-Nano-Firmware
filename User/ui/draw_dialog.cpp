	...
	case WM_NOTIFY_PARENT:
		if(pMsg->Data.v == WM_NOTIFICATION_RELEASED)
		{
			...
			{			
				...
				Chk_close_machine_flg = 0;//ȡ��֮����Դ���ػ���־���㣬��ֹ����
#if defined(TFT35)
                if((DialogType == DIALOG_TYPE_STOP))
				{
					if(from_flash_pic == 1)
				...
				{	
					...
					HAL::AT24CXX_Write(BAK_REPRINT_INFO, (uint8_t *)&tmpFlag,  4); 		// �����־(uint8_t) | checkXor(uint8_t) | checkSum(uint16_t)
					#endif

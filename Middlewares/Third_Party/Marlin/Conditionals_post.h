...
*/
    ...
    #define X_CENTER_IS_KINEMATIC 0
    #define Y_CENTER_IS_KINEMATIC 0

    #define X_CENTER_IS_CARTESIAN ((X_BED_SIZE) / 2)
    #define Y_CENTER_IS_CARTESIAN ((Y_BED_SIZE) / 2)
...
*/
	#define X_MIN_BED_IS_KINEMATIC (X_CENTER_IS_KINEMATIC - (X_BED_SIZE) / 2)
	#define X_MAX_BED_IS_KINEMATIC (X_CENTER_IS_KINEMATIC + (X_BED_SIZE) / 2)
	#define Y_MIN_BED_IS_KINEMATIC (Y_CENTER_IS_KINEMATIC - (Y_BED_SIZE) / 2)
	#define Y_MAX_BED_IS_KINEMATIC (Y_CENTER_IS_KINEMATIC + (Y_BED_SIZE) / 2)

	#define X_MIN_BED_IS_CARTESIAN (X_CENTER_IS_CARTESIAN - (X_BED_SIZE) / 2)
	#define X_MAX_BED_IS_CARTESIAN (X_CENTER_IS_CARTESIAN + (X_BED_SIZE) / 2)
	#define Y_MIN_BED_IS_CARTESIAN (Y_CENTER_IS_CARTESIAN - (Y_BED_SIZE) / 2)
	#define Y_MAX_BED_IS_CARTESIAN (Y_CENTER_IS_CARTESIAN + (Y_BED_SIZE) / 2)
...
#define Y_HOME_POS 0
   ...
   */
  #if 0//ENABLED(DELTA) && !defined(DELTA_HEIGHT)
...
//  #define HAS_MESH       (ENABLED(AUTO_BED_LEVELING_BILINEAR) || ENABLED(AUTO_BED_LEVELING_UBL) || ENABLED(MESH_BED_LEVELING))
	#define HAS_MESH			(AUTO_BED_LEVELING_BILINEAR|AUTO_BED_LEVELING_UBL|MESH_BED_LEVELING)

	//#define PLANNER_LEVELING      (OLDSCHOOL_ABL || ENABLED(MESH_BED_LEVELING) || UBL_SEGMENTED || ENABLED(SKEW_CORRECTION))
	#define PLANNER_LEVELING      (ABL_PLANAR | ABL_GRID | MESH_BED_LEVELING/*|UBL_SEGMENTED|SKEW_CORRECTION*/)
    ...
    //#if IS_KINEMATIC
     ...
     /*
      ...
      #define _MESH_MAX_Y (MAX_PROBE_Y - (MESH_INSET))
		*/
      #define _MESH_MIN_X_IS_KINEMATIC (MIN_PROBE_X + MESH_INSET)
      #define _MESH_MIN_Y_IS_KINEMATIC (MIN_PROBE_Y + MESH_INSET)
      #define _MESH_MAX_X_IS_KINEMATIC (MAX_PROBE_X - (MESH_INSET))
      #define _MESH_MAX_Y_IS_KINEMATIC (MAX_PROBE_Y - (MESH_INSET))			
   // #else
      ...
      #define _MESH_MAX_Y (min(Y_MAX_BED - (MESH_INSET), Y_MAX_POS + Y_PROBE_OFFSET_FROM_EXTRUDER))
		*/
      #define _MESH_MIN_X_IS_Cartesian (max(X_MIN_BED_IS_CARTESIAN + MESH_INSET, X_MIN_POS + X_PROBE_OFFSET_FROM_EXTRUDER))
      #define _MESH_MIN_Y_IS_Cartesian (max(Y_MIN_BED_IS_CARTESIAN + MESH_INSET, Y_MIN_POS + Y_PROBE_OFFSET_FROM_EXTRUDER))
      #define _MESH_MAX_X_IS_Cartesian (min(X_MAX_BED_IS_CARTESIAN - MESH_INSET, X_MAX_POS + X_PROBE_OFFSET_FROM_EXTRUDER))
      #define _MESH_MAX_Y_IS_Cartesian (min(Y_MAX_BED_IS_CARTESIAN - MESH_INSET, Y_MAX_POS + Y_PROBE_OFFSET_FROM_EXTRUDER))			
    //#endif
    /**
    ...
    //#if ENABLED(MESH_BED_LEVELING) || ENABLED(AUTO_BED_LEVELING_UBL)
      //#ifndef MESH_MIN_X
        //#define MESH_MIN_X _MESH_MIN_X
				...
				#define MESH_MIN_X_IS_KINEMATIC _MESH_MIN_X_IS_KINEMATIC
				#define MESH_MIN_X_IS_Cartesian 		_MESH_MIN_X_IS_Cartesian
      //#endif
      //#ifndef MESH_MIN_Y
      //  #define MESH_MIN_Y _MESH_MIN_Y
				
				#define MESH_MIN_Y_IS_KINEMATIC  _MESH_MIN_Y_IS_KINEMATIC
				#define MESH_MIN_Y_IS_Cartesian _MESH_MIN_Y_IS_Cartesian
      //#endif
      //#ifndef MESH_MAX_X
      //  #define MESH_MAX_X _MESH_MAX_X

				#define MESH_MAX_X_IS_KINEMATIC _MESH_MAX_X_IS_KINEMATIC
				#define MESH_MAX_X_IS_Cartesian _MESH_MAX_X_IS_Cartesian
     // #endif
      //#ifndef MESH_MAX_Y
      //  #define MESH_MAX_Y _MESH_MAX_Y

				#define MESH_MAX_Y_IS_KINEMATIC _MESH_MAX_Y_IS_KINEMATIC
				#define MESH_MAX_Y_IS_Cartesian _MESH_MAX_Y_IS_Cartesian
      //#endif
    //#endif

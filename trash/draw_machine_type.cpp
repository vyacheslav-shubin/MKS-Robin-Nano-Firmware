    ...
    switch (pMsg->MsgId)
    {
    	...
    	case WM_NOTIFY_PARENT:
    		if(pMsg->Data.v == WM_NOTIFICATION_RELEASED)
    		{
    			...
    			else if(pMsg->hWinSrc == XYZ_Sel.btnHandle)
    			{
    				last_disp_state = MACHINETYPE_UI;
    				//Clear_MachineType();
...
{   
    ...
    buttonXYZ.btnHandle = BUTTON_CreateEx(10,50,360,40,hMachineTypeWnd, BUTTON_CF_SHOW, 0, alloc_win_id());
    XYZ_Sel.btnHandle = BUTTON_CreateEx(370,50,90,40,hMachineTypeWnd, BUTTON_CF_SHOW, 0, alloc_win_id());
    ...
    BUTTON_SetBmpFileName(buttonXYZ.btnHandle,NULL,1);        
    ...
    {
        BUTTON_SetText(buttonXYZ.btnHandle, machine_menu.xyz);

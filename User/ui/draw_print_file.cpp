...
//	int buttonWidth = LCD_WIDTH/4;
	...
	{		
		GUI_DispStringAt("�����d��......", 300, 200);
	}	
	else
	{		
		GUI_DispStringAt("��������......", 300, 200);
	}
#endif	
...
//	dir_offset[curDirLever].curPage = 0;
	...
	if(card.gcodeFileList.index == 0)
	{
		...
		if(curDirLever == 0)
		{
			...
			{
				GUI_DispStringAt("�o�ļ�! ", 350, 200);
				GUI_DispStringAt("Ո����SD�� / U�P!", 310, 250);
			}
			else
			{
				GUI_DispStringAt("���ļ� !", 350, 200);
				GUI_DispStringAt("�����SD�� / U��!", 310, 250);
			}
			#endif
		...
		else
		{
			...
			{
				GUI_DispStringAt("�o�ļ�! ", 300, 200);
			}
			else
			{
				GUI_DispStringAt("���ļ� ! ",300, 200);
			}
			#endif

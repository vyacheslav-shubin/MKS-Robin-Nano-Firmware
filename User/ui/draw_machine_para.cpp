...
static BUTTON_STRUCT buttonMachineSetting,buttonTemperatureSetting,buttonMotorSetting,buttonAdvanceSetting;
...
{   
	...
	BUTTON_SetBitmapEx(buttonMachineSetting.btnHandle, 0, &bmp_struct,BMP_PIC_X, BMP_PIC_Y);

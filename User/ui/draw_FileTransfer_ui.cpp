...
void draw_dialog_filetransfer(uint8_t WifiTransferDialogType)
{
	...
	else
	{
		if(WifiTransferDialogType == 0)
		{
			GUI_DispStringAt("�ļ�����ʧ��!", 80, titleHeight  + 75);

		}
		else if(WifiTransferDialogType == 1)
		{
			GUI_DispStringAt("�ļ�����ɹ�!", 80, titleHeight  + 75);
		}
		else if(WifiTransferDialogType == 2)
		{	
			GUI_DispStringAt("�����Ƿ����洢�豸!", 40, titleHeight  + 75);
		}
	...
	{
		BUTTON_SetText(buttonReturn.btnHandle, "����\n");
	}	
...
void draw_filetansfer(uint8_t file_unzip_flg)
{
    ...
    if(gCfgItems.fileSysType == FILE_SYS_SD)
	{
		...
		{
			TEXT_SetText(FileTransferText,"�����ļ���");
		}
	}
	else if(gCfgItems.fileSysType == FILE_SYS_USB)
	{
		...
		else
		{
			if(file_unzip_flg == 1)
			{
				TEXT_SetText(FileTransferText,"�ļ���ѹ��");
			}
			else
			{
				TEXT_SetText(FileTransferText,"�ļ�������");

...
void set_value_confirm()
{
	...
	break;
       ...
       case zspeed:
        ...
        mksCfg.z_probe_speed_slow= (float)((uint32_t)mksCfg.z_probe_speed_fast>>1);  //����Ϊ���ٵ�һ�� 
...
{   
    ...
    BUTTON_SetBitmapEx(NumberKey_1.btnHandle,0,&bmp_struct68X40,0,0);//ͼƬ��СΪ68x40
    ...
    BUTTON_SetBitmapEx(NumberKey_4.btnHandle,0,&bmp_struct68X40,0,0);//ͼƬ��СΪ68x40
    ...
    BUTTON_SetBitmapEx(NumberKey_7.btnHandle,0,&bmp_struct68X40,0,0);//ͼƬ��СΪ68x40
    ...
    BUTTON_SetBitmapEx(NumberKey_0.btnHandle,0,&bmp_struct144X40,0,0);//ͼƬ��СΪ68x40

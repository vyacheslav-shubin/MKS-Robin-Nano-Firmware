...
static BUTTON_STRUCT OutTemperature_text,OutSpeed_text,OutLength_text;
static BUTTON_STRUCT InTemperature_value,InSpeed_value,InLength_value;
static BUTTON_STRUCT OutTemperature_value,OutSpeed_value,OutLength_value;
...
static void btnHandle_rest()
{
    ...
    OutTemperature_text.btnHandle = 0;
    ...
    OutTemperature_value.btnHandle = 0;   
    ...
    OutTemperature_default.btnHandle = 0;   
...
{   
    ...
    if(current_page != 1)
    {
        ...
        InTemperature_value.btnHandle = BUTTON_CreateEx(270,50+5,VALUE_DEFAULT_X,VALUE_DEFAULT_Y,hFilamentSettingsWnd, BUTTON_CF_SHOW, 0, alloc_win_id());
        InTemperature_default.btnHandle = BUTTON_CreateEx(370,50+5,VALUE_DEFAULT_X,VALUE_DEFAULT_Y,hFilamentSettingsWnd, BUTTON_CF_SHOW, 0, alloc_win_id());

        InSpeed_text.btnHandle = BUTTON_CreateEx(10,100,240,40,hFilamentSettingsWnd, BUTTON_CF_SHOW, 0, alloc_win_id());
        InSpeed_value.btnHandle = BUTTON_CreateEx(270,100+5,VALUE_DEFAULT_X,VALUE_DEFAULT_Y,hFilamentSettingsWnd, BUTTON_CF_SHOW, 0, alloc_win_id());
        InSpeed_default.btnHandle = BUTTON_CreateEx(370,100+5,VALUE_DEFAULT_X,VALUE_DEFAULT_Y,hFilamentSettingsWnd, BUTTON_CF_SHOW, 0, alloc_win_id());

        InLength_text.btnHandle = BUTTON_CreateEx(10,150,240,40,hFilamentSettingsWnd, BUTTON_CF_SHOW, 0, alloc_win_id());
        InLength_value.btnHandle = BUTTON_CreateEx(270,150+5,VALUE_DEFAULT_X,VALUE_DEFAULT_Y,hFilamentSettingsWnd, BUTTON_CF_SHOW, 0, alloc_win_id());
        InLength_default.btnHandle = BUTTON_CreateEx(370,150+5,VALUE_DEFAULT_X,VALUE_DEFAULT_Y,hFilamentSettingsWnd, BUTTON_CF_SHOW, 0, alloc_win_id());

        OutTemperature_text.btnHandle = BUTTON_CreateEx(10,200,240,40,hFilamentSettingsWnd, BUTTON_CF_SHOW, 0, alloc_win_id());
        OutTemperature_value.btnHandle = BUTTON_CreateEx(270,200+5,VALUE_DEFAULT_X,VALUE_DEFAULT_Y,hFilamentSettingsWnd, BUTTON_CF_SHOW, 0, alloc_win_id());
        OutTemperature_default.btnHandle = BUTTON_CreateEx(370,200+5,VALUE_DEFAULT_X,VALUE_DEFAULT_Y,hFilamentSettingsWnd, BUTTON_CF_SHOW, 0, alloc_win_id());

        BUTTON_SetBmpFileName(InTemperature_value.btnHandle, "bmp_value_blank.bin",1);        
        BUTTON_SetBmpFileName(InTemperature_default.btnHandle, "bmp_default.bin",1);
        BUTTON_SetBmpFileName(InLength_value.btnHandle, "bmp_value_blank.bin",1);
        BUTTON_SetBmpFileName(InLength_default.btnHandle, "bmp_default.bin",1);
        BUTTON_SetBmpFileName(InSpeed_value.btnHandle, "bmp_value_blank.bin",1);
        BUTTON_SetBmpFileName(InSpeed_default.btnHandle, "bmp_default.bin",1);     
        BUTTON_SetBmpFileName(OutTemperature_value.btnHandle, "bmp_value_blank.bin",1);
        BUTTON_SetBmpFileName(OutTemperature_default.btnHandle, "bmp_default.bin",1);  
        ...
        BUTTON_SetBmpFileName(OutTemperature_text.btnHandle,NULL,1);
        ...
        BUTTON_SetBitmapEx(OutTemperature_value.btnHandle,0,&bmp_struct70X28,0,0);
        BUTTON_SetBitmapEx(OutTemperature_default.btnHandle,0,&bmp_struct70X28,0,0); 
        ...
        BUTTON_SetTextAlign(OutTemperature_text.btnHandle,GUI_TA_LEFT|GUI_TA_VCENTER );   
        ...
        BUTTON_SetTextAlign(OutTemperature_value.btnHandle,GUI_TA_HCENTER|GUI_TA_VCENTER );
        ...
        BUTTON_SetBkColor(OutTemperature_value.btnHandle, BUTTON_CI_PRESSED, gCfgItems.value_bk_color);
        BUTTON_SetBkColor(OutTemperature_value.btnHandle, BUTTON_CI_UNPRESSED, gCfgItems.value_bk_color); 
        BUTTON_SetTextColor(OutTemperature_value.btnHandle, BUTTON_CI_PRESSED, gCfgItems.value_text_color);
        BUTTON_SetTextColor(OutTemperature_value.btnHandle, BUTTON_CI_UNPRESSED, gCfgItems.value_text_color);
       ...
       BUTTON_SetBkColor(OutTemperature_default.btnHandle, BUTTON_CI_PRESSED, gCfgItems.default_bk_color);
       BUTTON_SetBkColor(OutTemperature_default.btnHandle, BUTTON_CI_UNPRESSED, gCfgItems.default_bk_color); 
       BUTTON_SetTextColor(OutTemperature_default.btnHandle, BUTTON_CI_PRESSED, gCfgItems.default_text_color);
    ...
    {
        OutSpeed_text.btnHandle = BUTTON_CreateEx(10,50,240,40,hFilamentSettingsWnd, BUTTON_CF_SHOW, 0, alloc_win_id());
        OutSpeed_value.btnHandle = BUTTON_CreateEx(270,50+5,VALUE_DEFAULT_X,VALUE_DEFAULT_Y,hFilamentSettingsWnd, BUTTON_CF_SHOW, 0, alloc_win_id());
        OutSpeed_default.btnHandle = BUTTON_CreateEx(370,50+5,VALUE_DEFAULT_X,VALUE_DEFAULT_Y,hFilamentSettingsWnd, BUTTON_CF_SHOW, 0, alloc_win_id());

        OutLength_text.btnHandle = BUTTON_CreateEx(10,100,240,40,hFilamentSettingsWnd, BUTTON_CF_SHOW, 0, alloc_win_id());
        OutLength_value.btnHandle = BUTTON_CreateEx(270,100+5,VALUE_DEFAULT_X,VALUE_DEFAULT_Y,hFilamentSettingsWnd, BUTTON_CF_SHOW, 0, alloc_win_id());
        OutLength_default.btnHandle = BUTTON_CreateEx(370,100+5,VALUE_DEFAULT_X,VALUE_DEFAULT_Y,hFilamentSettingsWnd, BUTTON_CF_SHOW, 0, alloc_win_id());

        BUTTON_SetBmpFileName(OutSpeed_value.btnHandle, "bmp_value_blank.bin",1);
        BUTTON_SetBmpFileName(OutSpeed_default.btnHandle, "bmp_default.bin",1);
        BUTTON_SetBmpFileName(OutLength_value.btnHandle, "bmp_value_blank.bin",1);
        BUTTON_SetBmpFileName(OutLength_default.btnHandle, "bmp_default.bin",1);

...
void ManualLevelingUI::createControls() {
	...
	buttons.leveling3 = this->createButtonAt(1, 0, img_leveling_point3, _button_title(2));
	buttons.leveling4 = this->createButtonAt(0, 0, img_leveling_point4, _button_title(3));

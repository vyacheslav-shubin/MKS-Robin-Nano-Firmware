...
{   
    ...
    if(current_page != 1)
    {
        ...
        BUTTON_SetBmpFileName(XMaxFeedRate_value.btnHandle, "bmp_value_blank.bin",1);        
        BUTTON_SetBmpFileName(YMaxFeedRate_value.btnHandle, "bmp_value_blank.bin",1);
        BUTTON_SetBmpFileName(ZMaxFeedRate_value.btnHandle, "bmp_value_blank.bin",1);
        BUTTON_SetBmpFileName(E0MaxFeedRate_value.btnHandle, "bmp_value_blank.bin",1);
        //BUTTON_SetBmpFileName(XMaxFeedRate_default.btnHandle, "bmp_default.bin",1);
       // BUTTON_SetBmpFileName(YMaxFeedRate_default.btnHandle, "bmp_default.bin",1);     
        //BUTTON_SetBmpFileName(ZMaxFeedRate_default.btnHandle, "bmp_default.bin",1);
        //BUTTON_SetBmpFileName(E0MaxFeedRate_default.btnHandle, "bmp_default.bin",1);  
    ...
    else
    {
        ...
        BUTTON_SetBmpFileName(E1MaxFeedRate_value.btnHandle, "bmp_value_blank.bin",1);
        BUTTON_SetBmpFileName(E1MaxFeedRate_default.btnHandle, "bmp_default.bin",1);
